        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-white to-orange-50 p-4">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <Title level={3} className="!mb-2 font-black uppercase tracking-tight text-gray-800">Xác thực OTP</Title>
                ...
                <Form layout="vertical" onFinish={onFinish}>
                    ...
                    <Button 
                        ...
                        block 
                        loading={loading}
                        className="h-12 rounded-2xl bg-gradient-to-r from-red-500 to-orange-500 border-none hover:from-red-600 hover:to-orange-600 font-bold text-base shadow-lg shadow-orange-100 uppercase tracking-widest"
                        style={{
            ...
            <div className="fixed bottom-6 text-gray-300 text-[9px] uppercase font-bold tracking-[6px] opacity-40">
                EXEShop Security Protocol
            </div>
