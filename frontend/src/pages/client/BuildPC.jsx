...
import { Typography, Button, Card, Tag, Modal, Input, Radio, Space, Spin, message, Tooltip, Flex, Switch } from 'antd';
import { 
  ThunderboltOutlined, 
  SettingOutlined, 
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="text-center md:text-left max-w-2xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-orange-50 text-orange-600 rounded-full mb-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest">AI-Powered PC Builder</span>
              </div>
              <Title level={1} className="!mb-4 !text-5xl font-black tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="flex items-center justify-between mb-4 px-2">
               <Title level={4} className="!mb-0 font-black">Danh sách linh kiện</Title>
                    ...
                    <div className="flex items-center gap-6 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <Text className="text-[10px] font-black uppercase text-gray-400 tracking-widest">{slot.name}</Text>
                ...
                <div className="bg-orange-500 rounded-[34px] p-10 text-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-8 bg-white/20 w-fit px-3 py-1 rounded-full">
                      ...
                      <Text className="text-[10px] font-black uppercase text-white tracking-widest">Cấu hình của bạn</Text>
                    </div>
                    <Title level={1} className="!text-white !mb-4 !text-5xl font-black tracking-tight leading-none">
                ...
                <div className="p-10 space-y-8">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center text-lg">
                      ...
                      <Text className="font-black text-gray-900">{formatPrice(totalPrice)}</Text>
                    </div>
                    <div className="flex justify-between items-center text-lg">
                      <Text className="text-gray-400 font-bold">Lắp đặt & Giao hàng</Text>
                      <Text className="text-green-500 font-black">MIỄN PHÍ</Text>
                    </div>
                  </div>
                  ...
                  <Button 
                    ...
                    size="large" 
                    icon={<ShoppingCartOutlined />} 
                    className="h-16 text-xl font-black tracking-tight bg-orange-500 hover:!bg-orange-600 border-none rounded-3xl shadow-xl shadow-orange-100 transition-all"
                    onClick={handleAddAllToCart}
                  >
                    THÊM TẤT CẢ VÀO GIỎ
                  </Button>
      ...
      >
        <div className="space-y-4 mt-5">
          <div className="bg-gray-50/50 p-4 rounded-[20px] border border-gray-100">
            ...
            <div className="relative group bg-white rounded-[16px] overflow-hidden shadow-sm border border-gray-100 focus-within:border-orange-500/30 transition-all p-1">
               <Input 
                 ...
                 prefix={<span className="pl-2 pr-1 text-[10px] font-black text-orange-500/60 uppercase tracking-tight">VND</span>}
                 className="h-10 !text-sm font-black text-gray-900 w-full"
               />
            </div>
          ...
          <div className="flex items-center justify-between bg-orange-50/50 p-4 rounded-[20px] border border-orange-100">
            <div className="flex items-center gap-2">
              <ThunderboltOutlined className="text-orange-500 text-[10px]" />
              <div className="flex flex-col text-left">
                <Text className="text-[10px] font-black uppercase text-gray-800 tracking-tight">Bao gồm Gaming Gear</Text>
                <Text className="text-[8px] text-gray-500 font-medium">(Màn hình, phím, chuột...)</Text>
              </div>
            </div>
            <Switch 
              size="small" 
              checked={includeGear} 
              onChange={setIncludeGear}
              style={{ backgroundColor: includeGear ? '#f97316' : '#d1d5db' }}
            />
          </div>
