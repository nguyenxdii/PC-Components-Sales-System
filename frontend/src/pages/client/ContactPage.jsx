    ...
    <div className="bg-gray-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <Title className="!mb-4 text-4xl font-black">Liên hệ với EXEShop</Title>
          <Paragraph className="text-lg text-gray-500 max-w-2xl mx-auto">
            Chúng tôi luôn sẵn sàng lắng nghe và hỗ trợ bạn. Đừng ngần ngại liên hệ với EXEShop bất cứ khi nào bạn cần tư vấn về linh kiện PC.
          </Paragraph>
        </div>
        ...
        <div className="mt-20 overflow-hidden rounded-[40px] shadow-2xl h-[400px] relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/10">
            <Card className="rounded-3xl shadow-2xl p-6 text-center max-w-sm border-none">
               ...
               <Title level={4} className="!mb-2">Showroom EXEShop</Title>
