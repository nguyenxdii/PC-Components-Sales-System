...
const CartPage = () => {
  ...
  const columns = [
      ...
      render: (_, record) => (
        <div className="flex items-center gap-4 py-2">
          <div className="w-16 h-16 bg-white border border-gray-100 rounded-xl overflow-hidden p-1 flex-shrink-0">
            <img 
              src={record.productImage || "/images/placeholder.png"} 
          ...
          <div>
            ...
            <Tag borderless color="blue" className="text-[10px] uppercase font-bold px-2 rounded-full">Linh kiện PC</Tag>
          </div>
        </div>
      ),
    },
    ...
    },
    {
      ...
      key: "subtotal",
      render: (_, record) => (
        <span className="font-black text-red-600 block text-right">
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="container mx-auto px-4">
        ...
        <Title level={2} className="!mb-8 !text-3xl font-black text-gray-900 uppercase tracking-tight">
        ...
        <div className="grid grid-cols-12 gap-8 items-start">
          ...
          <div className="col-span-12 lg:col-span-4">
            <Card className="rounded-3xl shadow-lg border-none">
              <Title level={4} className="!mb-6 uppercase text-sm font-black text-gray-400 tracking-widest">Tóm tắt đơn hàng</Title>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-black text-red-600 leading-none mb-1">
                ...
                <div className="pt-6">
                   <Button 
                    ...
                    block 
                    className="h-16 rounded-2xl font-black text-lg shadow-xl shadow-red-100 border-none bg-gradient-to-r from-red-600 to-orange-500 hover:scale-[1.02] transition-transform"
